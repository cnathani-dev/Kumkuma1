...
export const ClientActivitiesContext = createContext<ClientActivitiesContextType | undefined>(undefined);
export const useClientActivities = () => {
    const context = useContext(ClientActivitiesContext);
    if (!context) throw new Error('useClientActivities must be used within a ClientActivitiesProvider');
    return context;
};
